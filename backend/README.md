...
## Project Structure
    ...
    ├── hfdksjlafhkdlshl_d_110184  # Django project configurations
...
1. Clone this repo and `cd hfdksjlafhkdlshl_d_110184`
...
2. Clone this repo and `cd hfdksjlafhkdlshl_d_110184`
